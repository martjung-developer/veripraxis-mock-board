...
const REVIEWS: Review[] = [
  {
    id: '1',
    program: 'Bachelor of Laws / Juris Doctor',
    shortCode: 'LLB / JD',
    category: 'Law & Government',
    status: 'available',
    questions: 300,
    duration: '12 hrs',
    subject: 'Philippine Bar Examination',
  },
  {
    id: '2',
    ...
    questions: 300,
    duration: '10 hrs',
    subject: 'Pharmacist Licensure Examination',
  },
  {
    id: '3',
    ...
    questions: 300,
    duration: '12 hrs',
    subject: 'Electrical Engineer Licensure Examination',
  },
...
{ id: '41', program: 'Bachelor of Science in Architecture',                     shortCode: 'BSArch',      category: 'Architecture & Design',  status: 'coming_soon' },

// ── Business & Finance ──
{ id: '42', program: 'Bachelor of Science in Accountancy',                      shortCode: 'BSA',         category: 'Business & Finance',     status: 'coming_soon' },
{ id: '43', program: 'Bachelor of Science in Real Estate Management',           shortCode: 'BSREM',       category: 'Business & Finance',     status: 'coming_soon' },
{ id: '44', program: 'Bachelor of Science in Customs Administration',           shortCode: 'BSCA',        category: 'Business & Finance',     status: 'coming_soon' },

// ── Education ──
{ id: '45', program: 'Bachelor of Science in Secondary Education – Filipino',   shortCode: 'BSEd-FIL',    category: 'Education',              status: 'coming_soon' },
{ id: '46', program: 'Bachelor of Science in Secondary Education – Mathematics',shortCode: 'BSEd-MATH',   category: 'Education',              status: 'coming_soon' },
{ id: '47', program: 'Bachelor of Science in Secondary Education – Science',    shortCode: 'BSEd-SCI',    category: 'Education',              status: 'coming_soon' },
{ id: '48', program: 'Bachelor of Science in Secondary Education – Social Studies', shortCode: 'BSEd-SS', category: 'Education', status: 'coming_soon' },
{ id: '49', program: 'Bachelor of Science in Secondary Education – MAPEH',      shortCode: 'BSEd-MAPEH',  category: 'Education',              status: 'coming_soon' },
{ id: '50', program: 'Bachelor of Science in Secondary Education – TLE',        shortCode: 'BSEd-TLE',    category: 'Education',              status: 'coming_soon' },
{ id: '51', program: 'Bachelor of Science in Elementary Education',             shortCode: 'BEEd',        category: 'Education',              status: 'coming_soon' },
{ id: '52', program: 'Bachelor of Early Childhood Education',                   shortCode: 'BECEd',       category: 'Education',              status: 'coming_soon' },
{ id: '53', program: 'Bachelor of Special Needs Education',                     shortCode: 'BSNEd',       category: 'Education',              status: 'coming_soon' },
{ id: '54', program: 'Bachelor of Physical Education',                          shortCode: 'BPEd',        category: 'Education',              status: 'coming_soon' },
{ id: '55', program: 'Bachelor of Technical-Vocational Teacher Education',      shortCode: 'BTVTEd',      category: 'Education',              status: 'coming_soon' },
{ id: '56', program: 'Bachelor of Culture and Arts Education',                  shortCode: 'BCAEd',       category: 'Education',              status: 'coming_soon' },
{ id: '57', program: 'Bachelor of Science in Secondary Education – English',    shortCode: 'BSEd-ENG',    category: 'Education',              status: 'coming_soon' },

// ── Natural Sciences ──
{ id: '58', program: 'Bachelor of Science in Agriculture',                      shortCode: 'BSAg',        category: 'Natural Sciences',       status: 'coming_soon' },
{ id: '59', program: 'Bachelor of Science in Forestry',                         shortCode: 'BSF',         category: 'Natural Sciences',       status: 'coming_soon' },
{ id: '60', program: 'Bachelor of Science in Fisheries',                        shortCode: 'BSFish',      category: 'Natural Sciences',       status: 'coming_soon' },
{ id: '61', program: 'Bachelor of Science in Geology',                          shortCode: 'BSGeol',      category: 'Natural Sciences',       status: 'coming_soon' },
{ id: '62', program: 'Bachelor of Science in Chemistry',                        shortCode: 'BSChem',      category: 'Natural Sciences',       status: 'coming_soon' },

// ── Social Sciences ──
{ id: '63', program: 'Bachelor of Science in Psychology',                       shortCode: 'BSPsych',     category: 'Social Sciences',        status: 'coming_soon' },
{ id: '64', program: 'Bachelor of Science in Social Work',                      shortCode: 'BSSW',        category: 'Social Sciences',        status: 'coming_soon' },
{ id: '65', program: 'Bachelor of Science in Guidance and Counseling',          shortCode: 'BSGC',        category: 'Social Sciences',        status: 'coming_soon' },
{ id: '66', program: 'Bachelor of Science in Criminology',                      shortCode: 'BSCrim',      category: 'Social Sciences',        status: 'coming_soon' },
{ id: '67', program: 'Bachelor of Library and Information Science',             shortCode: 'BLIS',        category: 'Social Sciences',        status: 'coming_soon' },

// ── Law & Government ──
{ id: '68', program: 'Bachelor of Laws / Juris Doctor',                         shortCode: 'LLB / JD',    category: 'Law & Government',       status: 'coming_soon' },
{ id: '69', program: 'Bachelor of Science in Public Administration',            shortCode: 'BSPA',        category: 'Law & Government',       status: 'coming_soon' },

// ── Maritime ──
{ id: '70', program: 'Bachelor of Science in Marine Transportation',            shortCode: 'BSMT',        category: 'Maritime',               status: 'coming_soon' },
{ id: '71', program: 'Bachelor of Science in Marine Engineering',               shortCode: 'BSMarE',      category: 'Maritime',               status: 'coming_soon' },

// ── Hospitality & Tourism ──
{ id: '72', program: 'Bachelor of Science in Tourism Management',               shortCode: 'BSTM',        category: 'Hospitality & Tourism',  status: 'coming_soon' },
{ id: '73', program: 'Bachelor of Science in Hotel and Restaurant Management',  shortCode: 'BSHRM',       category: 'Hospitality & Tourism',  status: 'coming_soon' },
]
...
export default function ReviewsPage() {
  ...
  const availableCount = REVIEWS.filter(
      ...
      <div className={styles.header}>
        <div>
          ...
          <p className={styles.subtitle}>
            Practice exams to improve your skills
          </p>
        </div>
              ...
              n === '…' ? (
                ...
                <button
                  ...
                  className={`${styles.pageNum} ${
                    safePage === n ? styles.pageNumActive : ''
                  }`}
