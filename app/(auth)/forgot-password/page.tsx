          ...
          <AnimatePresence mode="wait">
            {!sent ? (
              <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0, y: -8 }}>
                ...
                <p className={styles.subheading}>Enter your email and we&apos;ll send a reset link. Expires in 1 hour.</p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  <div className={styles.fieldGroup}>
                    ...
                    <div className={styles.inputWrap}>
                      ...
                      <input id="reset-email" className={`${styles.input} ${styles.inputHasIcon}`}
                  ...
                  <motion.button type="submit" className={styles.submitBtn} disabled={loading}
                    ...
                    {loading ? 'Sending…' : <> Send Reset Link <ArrowRight size={15} strokeWidth={2.5} /></>}
                  </motion.button>
              ...
              <motion.div key="sent" className={styles.successWrap}
                ...
                <button className={styles.submitBtn} onClick={() => { setSent(false); setEmail('') }} style={{ marginTop: '0.5rem' }}>
                  Try a different email
                </button>
                <Link href="/login" className={styles.switchLink} style={{ marginTop: '0.5rem', fontSize: '0.82rem' }}>
                  Back to sign in
                </Link>
              </motion.div>
            )}
