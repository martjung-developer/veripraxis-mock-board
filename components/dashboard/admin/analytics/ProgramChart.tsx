// components/dashboard/admin/analytics/ProgramChart.tsx
// Pure UI — renders the Program Performance bar chart. No data fetching.
...
import type { ProgramPerf } from '@/lib/types/admin/analytics/analytics.types'
...
export default function ProgramChart({ programPerf }: ProgramChartProps) {
  return (
