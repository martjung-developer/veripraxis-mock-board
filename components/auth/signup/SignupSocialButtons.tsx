// components/auth/signup/SignupSocialButtons.tsx
import styles from '@/app/(auth)/auth.module.css'

interface SignupSocialButtonsProps {
  onGoogle:   () => void
  onFacebook: () => void
}

export function SignupSocialButtons({ onGoogle, onFacebook }: SignupSocialButtonsProps) {
  return (
    <>
      ...
      <div className={styles.socialGroup}>
        <button type="button" className={styles.googleBtn} onClick={onGoogle}>
        ...
        <button type="button" className={styles.facebookBtn} onClick={onFacebook}>
